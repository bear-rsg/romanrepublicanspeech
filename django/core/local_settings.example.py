...
ALLOWED_HOSTS = ['*']/['romanrepublicanspeech.bham.ac.uk']
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'romanrepublicanspeech.sqlite3'),
        'TEST': {
            'NAME': os.path.join(BASE_DIR, 'romanrepublicanspeech_TEST.sqlite3'),
        },
    }
}
